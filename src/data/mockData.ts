...
export const mockProducts: Product[] = [
    ...
    {
        id: '93b4c5d6-e7f8-49a0-0b1c-2d3e4f5a6b77',
    ...
    {
        id: 'c4b5c6d7-e8f9-50a1-1b2c-3d4e5f6a7b88',
        name: 'KILL MY DOUBT',
        price: 400,
    ...
    {
        id: 'd5b6c7d8-e9f0-51a2-2b3c-4d5e6f7a8b99',
    ...
    },
    {
        ...
        name: 'Proof',
        price: 550,
        image_url: '/images/bts-proof.webp',
        category: 'album',
        artist: 'BTS',
        is_new: false,
    ...
    {
        id: 'f1a2b3c4-d5e6-47f8-9a0b-1c2d3e4f5a67',
        name: "I'VE MINE (1st EP)",
        price: 420,
        image_url: '/images/ive-mine.jpg',
        category: 'album',
        artist: 'IVE',
        is_new: true,
        description: 'El primer EP de IVE. Incluye el exitoso sencillo "After LIKE" y muestra la identidad musical única del grupo con un sonido fresco y confiado.',
        description_en: "IVE's first EP. Includes the hit single \"After LIKE\" and showcases the group's unique musical identity with a fresh and confident sound.",
        description_ko: '아이브의 첫 번째 EP. 히트 싱글 "After LIKE"가 수록되어 있으며, 신선하고 자신감 넘치는 사운드로 그룹의 독특한 음악적 정체성을 보여줍니다.',
        stock: 45,
        youtube_video_id: 'F0BNFnJjDiw',
    },
];
