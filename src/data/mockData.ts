...
export const mockProducts: Product[] = [
    {
        ...
        price: 29.99,
        image_url: 'https://placehold.co/600x600?text=Map+of+the+Soul+7',
        category: 'album',
        artist: 'BTS',
        is_new: false,
    ...
    },
    {
        ...
        price: 24.50,
        image_url: 'https://placehold.co/600x600?text=NewJeans+Get+Up',
        category: 'album',
        artist: 'NewJeans',
        is_new: true,
    ...
    },
    {
        ...
        name: 'Caratbong V3',
        price: 55.00,
        image_url: 'https://placehold.co/600x600?text=Caratbong+V3',
        category: 'lightstick',
        artist: 'Seventeen',
        is_new: true,
    ...
    },
    {
        ...
        price: 65.00,
        image_url: 'https://placehold.co/600x600?text=BP+Hoodie',
        category: 'merch',
        artist: 'BLACKPINK',
        is_new: false,
    ...
    },
    {
        ...
        price: 32.00,
        image_url: 'https://placehold.co/600x600?text=5-STAR',
        category: 'album',
        artist: 'Stray Kids',
        is_new: false,
    ...
    },
    {
        ...
        name: 'CANDYBONG ∞',
        price: 58.00,
        image_url: 'https://placehold.co/600x600?text=CANDYBONG',
        category: 'lightstick',
        artist: 'TWICE',
        is_new: true,
