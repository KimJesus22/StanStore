...
const supabaseAdmin = createClient(
    ...
    process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY! // Fallback ONLY for dev if specific key missing, but explicit admin key preferred
);
